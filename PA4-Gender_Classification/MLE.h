...
public:
	 ...
	 * by the total number of samples.
	 * 
	 * @param data vector of Xx1 input samples
	 * @return Xx1 sample mean vector
	 */
	static VectorXf calculateSampleMean(vector<VectorXf> data);
	 ...
	 * 
	 * @param data vector of Xx1 input samples
	 * @param sampleMean Xx1 sample mean
	 * @return XxX sample covariance matrix
	 */
	static MatrixXf calculateSampleCovariance(vector<VectorXf> data, VectorXf sampleMean);
